        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-6 py-2.5 sm:py-3.5 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3.5 min-w-0">
            ...
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              <h1 className="text-lg sm:text-2xl md:text-3xl font-black tracking-tight bg-gradient-to-r from-teal-500 via-emerald-400 to-teal-600 dark:from-teal-400 dark:via-emerald-300 dark:to-teal-300 bg-clip-text text-transparent truncate leading-tight flex-shrink-0">
                Tripwise
              </h1>
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2.5 flex-shrink-0">
            <button
              ...
              className="flex items-center gap-1 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-teal-500/40 text-slate-700 dark:text-slate-300 p-2 sm:px-3.5 sm:py-2 rounded-xl sm:rounded-2xl text-xs font-extrabold transition shadow-sm"
            ...
            {userProfile ? (
              <div className="flex items-center gap-1.5 sm:gap-2">
                <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-2 py-1.5 rounded-xl sm:rounded-2xl">
                  {userProfile.avatar || userProfile.photoURL ? (
                    ...
                    <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-teal-500/20 text-teal-600 dark:text-teal-400 font-bold text-[9px] flex items-center justify-center">
                ...
                <button
                  onClick={onSignOut}
                  className="flex items-center gap-1 p-2 sm:px-2.5 sm:py-1.5 bg-rose-500/10 border border-rose-500/25 text-rose-500 hover:bg-rose-500/20 rounded-xl text-xs font-bold transition shadow-sm"
                  title="Sign Out"
                >
              ...
              <button
                ...
                className="flex items-center gap-1 px-3 py-2 bg-teal-500 hover:bg-teal-400 text-slate-950 rounded-xl text-xs font-extrabold transition shadow-md shadow-teal-500/15"
              >
            ...
            <button
              ...
              className="flex items-center gap-1 bg-teal-500/10 text-teal-600 dark:text-teal-400 border border-teal-500/30 hover:bg-teal-500/20 p-2 sm:px-3.5 sm:py-2 rounded-xl sm:rounded-2xl text-xs font-extrabold transition shadow-sm"
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 py-3 px-4 text-xs sm:text-sm font-extrabold border-b-[3px] transition-all flex-shrink-0 whitespace-nowrap ${
                  isActive
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center py-1.5 px-2.5 rounded-2xl transition-all relative ${
                isActive
                  ? 'bg-teal-500 text-slate-950 font-black shadow-md shadow-teal-500/20 scale-105'
            ...
            >
              ...
              {tab.badge !== undefined && tab.badge > 0 && (
                <span
                  className={`absolute -top-1 -right-1 text-[8px] font-black px-1.5 py-0.2 rounded-full ${
                    isActive
