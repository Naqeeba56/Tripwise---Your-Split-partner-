    ...
    <div className="space-y-5 sm:space-y-7 max-w-4xl mx-auto pb-16 sm:pb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800/80 p-4 sm:p-5 rounded-3xl shadow-sm">
          ...
          <h3 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-slate-100 mt-1 truncate">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800/80 p-4 sm:p-5 rounded-3xl shadow-sm">
          ...
          <h3 className="text-xl sm:text-2xl font-black text-teal-600 dark:text-teal-400 mt-1 truncate">
        ...
        >
          ...
          <h3 className="text-xl sm:text-2xl font-black mt-1 truncate flex items-center gap-1">
            {userBalance > 0 ? (
              <>
              ...
              <>
                <TrendingDown className="w-5 h-5 stroke-[3]" />
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800/80 rounded-3xl p-4 sm:p-6 shadow-sm">
        <h3 className="text-sm sm:text-base font-extrabold text-slate-900 dark:text-slate-100 mb-3 flex items-center gap-2">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-slate-800/60 pb-3.5">
          <div>
            <h2 className="text-base sm:text-xl font-black text-slate-900 dark:text-slate-100 flex items-center gap-2">
              <ShieldCheck className="w-5 h-5 text-teal-500 stroke-[2.5]" />
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] sm:text-xs bg-teal-500/10 text-teal-600 dark:text-teal-400 border border-teal-500/30 px-3 py-1 rounded-full font-extrabold">
              {pendingCount} Pending
            </span>

            <button
              onClick={() => setShowPdfModal(true)}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-teal-500 hover:bg-teal-400 text-slate-950 font-extrabold text-xs transition shadow-sm"
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3.5">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        {fromAvatar ? (
                          ...
                          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-rose-500/10 text-rose-500 font-black text-xs flex items-center justify-center">
                            {s.from[0]}
                          </div>
                        )}
                      ...
                      <div className="flex flex-col items-center px-1">
                        <ArrowRight className="w-4 h-4 text-teal-500 stroke-[3]" />
                      ...
                      <div className="flex items-center gap-2">
                        {toAvatar ? (
                          ...
                          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-emerald-500/10 text-emerald-500 font-black text-xs flex items-center justify-center">
                            {s.to[0]}
                          </div>
                        )}
                        <div>
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-3 pt-2 sm:pt-0 border-t sm:border-0 border-slate-200/60 dark:border-slate-800/60">
                      <span className="text-base sm:text-xl font-black text-slate-900 dark:text-slate-100">
                        ₹{Number(s.amount).toLocaleString('en-IN')}
                      </span>

                      {isSettled ? (
                        <div className="text-xs font-extrabold px-3 py-1.5 rounded-xl bg-emerald-500 text-slate-950 flex items-center gap-1">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="text-xs font-extrabold px-3.5 py-2 rounded-xl bg-teal-500 hover:bg-teal-400 text-slate-950 shadow-sm transition active:scale-95 flex items-center gap-1"
                          >
                          ...
                          <button
                            ...
                            className="text-xs font-extrabold px-3 py-2 rounded-xl bg-amber-500/15 text-amber-500 border border-amber-500/30 hover:bg-amber-500/25 transition active:scale-95"
                          >
                            Cash
                          </button>
                        </div>
